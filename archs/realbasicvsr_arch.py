...
from archs.basicvsr_arch import BasicVSR, ConvResidualBlocks
...
class RealBasicVSR(nn.Module):
    ...
    def __init__(self,
        ...
        self.image_cleaning = nn.Sequential(
            ConvResidualBlocks(3, mid_channels, num_cleaning_blocks),
        ...
        # BasicVSR
        self.basicvsr = BasicVSR(mid_channels, num_propagation_blocks,
                                    spynet_path)
